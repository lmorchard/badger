...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BadgeAward.claimed'
        db.add_column('badges_badgeaward', 'claimed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'BadgeAward.hidden'
        db.add_column('badges_badgeaward', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'BadgeNomination.approved_why'
        db.add_column('badges_badgenomination', 'approved_why', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BadgeAward.claimed'
        db.delete_column('badges_badgeaward', 'claimed')

        # Deleting field 'BadgeAward.hidden'
        db.delete_column('badges_badgeaward', 'hidden')

        # Deleting field 'BadgeNomination.approved_why'
        db.delete_column('badges_badgenomination', 'approved_why')
    ...
    models = {
        ...
        'badges.badgenomination': {
            'Meta': {'unique_together': "(('badge', 'nominee', 'nominator'),)", 'object_name': 'BadgeNomination'},
