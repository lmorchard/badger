...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'BadgeAwardee', fields ['claim_code']
        db.create_unique('badges_badgeawardee', ['claim_code'])

        # Deleting field 'Badge.only_creator_can_nominate'
        db.delete_column('badges_badge', 'only_creator_can_nominate')
    ...
    models = {
        ...
        'badges.badgeawardee': {
            ...
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'fm4yprf'", 'max_length': '7'}),
