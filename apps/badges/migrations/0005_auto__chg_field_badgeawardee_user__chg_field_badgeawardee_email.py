...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BadgeAwardee.user'
        db.alter_column('badges_badgeawardee', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))

        # Changing field 'BadgeAwardee.email'
        db.alter_column('badges_badgeawardee', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'BadgeAwardee.user'
        db.alter_column('badges_badgeawardee', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'BadgeAwardee.email'
        db.alter_column('badges_badgeawardee', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
