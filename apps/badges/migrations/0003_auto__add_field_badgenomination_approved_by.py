...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BadgeNomination.approved_by'
        db.add_column('badges_badgenomination', 'approved_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BadgeNomination.approved_by'
        db.delete_column('badges_badgenomination', 'approved_by_id')
