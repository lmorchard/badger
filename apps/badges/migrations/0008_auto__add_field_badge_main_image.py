...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.main_image'
        db.add_column('badges_badge', 'main_image', self.gf('django.db.models.fields.files.ImageField')(max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.main_image'
        db.delete_column('badges_badge', 'main_image')
