...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BadgeAward.ignored'
        db.add_column('badges_badgeaward', 'ignored', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BadgeAward.ignored'
        db.delete_column('badges_badgeaward', 'ignored')
