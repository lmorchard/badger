...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'BadgeAwardee', fields ['user', 'email']
        db.create_unique('badges_badgeawardee', ['user_id', 'email'])

        # Adding unique constraint on 'Badge', fields ['slug', 'title']
        db.create_unique('badges_badge', ['slug', 'title'])

        # Adding unique constraint on 'BadgeNomination', fields ['nominator', 'badge', 'nominee']
        db.create_unique('badges_badgenomination', ['nominator_id', 'badge_id', 'nominee_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BadgeAwardee', fields ['user', 'email']
        db.delete_unique('badges_badgeawardee', ['user_id', 'email'])

        # Removing unique constraint on 'Badge', fields ['slug', 'title']
        db.delete_unique('badges_badge', ['slug', 'title'])

        # Removing unique constraint on 'BadgeNomination', fields ['nominator', 'badge', 'nominee']
        db.delete_unique('badges_badgenomination', ['nominator_id', 'badge_id', 'nominee_id'])
